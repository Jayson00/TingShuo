...
public class CollectActivity extends BaseActivity implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    protected void onStart() {
        if (UserUtils.getInstance().getStatus()){
            ...
            if (NetworkUtils.isConnected()) {
                requestGetCollectJson(UrlValue.GetCollection, UserUtils.getInstance().getUser());
            }else {
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        SPUtils.getInstance().put("type",UrlValue.GetCollection);
