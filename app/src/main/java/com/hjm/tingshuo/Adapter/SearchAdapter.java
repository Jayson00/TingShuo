...
/**
 * Created by linghao on 2018/8/14.
 */

public class SearchAdapter extends BaseQuickAdapter<MusicBean.DataBean,BaseViewHolder> {

    private Context mContext;

    public SearchAdapter(@Nullable List<MusicBean.DataBean> data,Context context) {
