...
public class Home3_testAdapter extends RecyclerView.Adapter<Home3_testAdapter.ViewHolder> {
    ...
    public Home3_testAdapter(Context context, List<SongNameListBean> myLiveList) {
