...
public class CollectAdapter extends BaseQuickAdapter<UserBean.DataBean,BaseViewHolder> {

    private Context mContext;

    public CollectAdapter(@Nullable List<UserBean.DataBean> data, Context context) {
