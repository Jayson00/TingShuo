 ...
 * Original file: D:\\Graduatedemo\\Tingshuo\\app\\src\\main\\aidl\\com\\hjm\\tingshuo\\LocalMusicServiceAidl.aidl
 */
package com.hjm.tingshuo;
// Declare any non-default types here with import statements

public interface LocalMusicServiceAidl extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.hjm.tingshuo.LocalMusicServiceAidl
{
private static final java.lang.String DESCRIPTOR = "com.hjm.tingshuo.LocalMusicServiceAidl";
...
/**
 * Cast an IBinder object into an com.hjm.tingshuo.LocalMusicServiceAidl interface,
 * generating a proxy if needed.
 */
public static com.hjm.tingshuo.LocalMusicServiceAidl asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.hjm.tingshuo.LocalMusicServiceAidl))) {
return ((com.hjm.tingshuo.LocalMusicServiceAidl)iin);
}
return new com.hjm.tingshuo.LocalMusicServiceAidl.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getPlayMode();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
private static class Proxy implements com.hjm.tingshuo.LocalMusicServiceAidl
{
...
@Override public void setPlayMode() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public java.lang.String getPlayMode() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
static final int TRANSACTION_getAuthor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getUrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
...
public void setPlayMode() throws android.os.RemoteException;
public java.lang.String getPlayMode() throws android.os.RemoteException;
